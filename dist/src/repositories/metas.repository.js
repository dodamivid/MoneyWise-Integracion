...
exports.metasRepository = exports.MetasRepository = void 0;
/**
...
class MetasRepository {
    ...
    async findAll(filters = {}, pagination) {
        ...
        if (filters.usuarioId !== undefined) {
            filteredMetas = filteredMetas.filter((meta) => meta.usuarioId === filters.usuarioId);
        }
        ...
        if (filters.desde) {
            ...
            filteredMetas = filteredMetas.filter((meta) => new Date(meta.fechaInicio) >= desde);
        }
        if (filters.hasta) {
        ...
        if (pagination?.orden) {
            ...
            filteredMetas = this.sortMetas(filteredMetas, campo, direccion);
        }
     ...
     * ```
     */
    async update(metaId, updateData) {
        ...
        updatedMeta.porcentajeAvance = this.calcularPorcentajeAvance(ahorroReal, montoObjetivo);
     ...
     */
    calcularPorcentajeAvance(ahorroReal, montoObjetivo) {
        if (montoObjetivo === 0) {
            return 0;
        }
     ...
     */
    sortMetas(metas, campo, direccion) {
...
exports.MetasRepository = MetasRepository;
/**
 ...
 * ```
 */
exports.metasRepository = new MetasRepository();
