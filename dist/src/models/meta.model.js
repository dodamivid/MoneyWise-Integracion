...
exports.MetaQueryParamsSchema = exports.MetaIdSchema = exports.UpdateMetaSchema = exports.CreateMetaSchema = exports.MetaSchema = void 0;
...
exports.MetaSchema = zod_1.z.object({
     ...
     * @example 7
     */
    metaId: zod_1.z.number().int().positive({
 ...
 * ```
 */
exports.CreateMetaSchema = exports.MetaSchema.omit({
    metaId: true,
    ahorroReal: true,
 ...
 * ```
 */
exports.UpdateMetaSchema = exports.MetaSchema.omit({
    metaId: true,
    usuarioId: true,
    porcentajeAvance: true,
    creadoEn: true,
 ...
 * ```
 */
exports.MetaIdSchema = zod_1.z.number().int().positive({
 ...
 * ```
 */
exports.MetaQueryParamsSchema = zod_1.z.object({
    /**
     * ID del usuario para filtrar metas (solo admin puede usar este filtro).
     */
    usuarioId: zod_1.z.number().int().positive().optional(),
    /**
     ...
     */
    tamanoPagina: zod_1.z.number().int().positive().max(100).default(20),
    /**
    ...
    orden: zod_1.z
        ...
        message: "Orden inválido. Use: fechaInicio|fechaFin|creadoEn|montoObjetivo|porcentajeAvance[:asc|:desc]",
    })
        .optional(),
});
